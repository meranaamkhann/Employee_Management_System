...
export default function AttendancePage() {
  ...
  const { data, isLoading } = useMyAttendance({ page: 0 }, hasEmployee)
  const { data: summary } = useMonthlySummary(currentMonth, undefined, hasEmployee)
    ...
    <div className="flex flex-col gap-6">
      ...
      {!hasEmployee ? (
        <NoEmployeeLinkedState
          icon={Clock}
          feature="personal clock-in tracking"
          adminHint="You can still manage attendance for your team from the Employees page."
        />
      ) : (
        <>
