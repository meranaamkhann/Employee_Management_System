  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-paper-100 px-6">
      <div className="w-full max-w-sm">
        ...
        {submitted ? (
          <div className="rounded-2xl border border-paper-300 bg-white p-6 text-center shadow-card">
            ...
            <Link to="/login" className="mt-6 inline-block text-sm font-medium text-ink-900 underline">
              Back to sign in
            </Link>
          </div>
        ) : (
          <>
            ...
            <Link to="/login" className="mt-6 inline-block text-sm text-ink-600 hover:text-ink-900">
              ← Back to sign in
            </Link>
          </>
        )}
