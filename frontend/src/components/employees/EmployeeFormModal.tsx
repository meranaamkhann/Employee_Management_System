    ...
    <Modal isOpen={isOpen} onClose={onClose} title={isEdit ? 'Edit employee' : 'Add employee'} maxWidth="max-w-2xl">
      <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-1.5">
          <label className="text-sm font-medium text-ink-800">Notes</label>
          <textarea
            className="min-h-20 w-full rounded-lg border border-paper-300 bg-white px-3.5 py-2.5 text-sm text-ink-900 focus:border-brass-500 focus:outline-none focus:ring-2 focus:ring-brass-400/50"
            {...register('notes')}
          />
        </div>
